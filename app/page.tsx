...
const tools = [
  ...
  },
  {
    ...
    description: "Generate barcodes from text or numbers for easy scanning",
  ...
  },
  {
    ...
    description: "Check current weather conditions by location",
    icon: <Cloud className="h-8 w-8 text-primary" />,
    href: "/weather",
  },
  {
    title: "To-Do List",
    description: "Manage your tasks with a simple list",
  ...
  {
    title: "Color Picker",
    description: "Select and copy color codes in various formats",
  ...
  },
  {
    ...
    description: "Calculate tips and split bills among people",
    icon: <DollarSign className="h-8 w-8 text-primary" />,
    href: "/tip-calculator",
  },
  {
    title: "Countdown Timer",
    description: "Count down to important dates and events",
    icon: <Clock className="h-8 w-8 text-primary" />,
    href: "/countdown-timer",
  },
  {
    title: "Dice Roller",
    description: "Roll virtual dice with realistic animations",
  ...
  },
  {
    ...
    icon: <Clock4 className="h-8 w-8 text-primary" />,
    href: "/pomodoro-timer",
    badge: "Productivity",
  },
  {
    title: "Image Carousel",
    description: "Create beautiful image slideshows",
    icon: <ImageIcon className="h-8 w-8 text-primary" />,
    href: "/image-carousel",
  },
  {
    title: "Drawing Canvas",
    description: "Draw and sketch with digital tools",
  ...
  },
  {
    ...
    description: "Classic game with animated gameplay",
  ...
  },
  {
    ...
    description: "Write HTML and CSS code and see live results",
  ...
  {
    title: "Notes App",
    description: "Create and organize your sticky notes",
  ...
  },
  {
    ...
    description: "Create professional pie charts for presentations",
    icon: <PieChart className="h-8 w-8 text-primary" />,
    href: "/pie-chart-generator",
    badge: "Charts",
  },
  {
    title: "File Converter",
    description: "Convert images and text files client-side",
  ...
  },
  {
    ...
    description: "Visualize microphone or audio file input",
    icon: <Music className="h-8 w-8 text-primary" />,
    href: "/audio-visualizer",
    badge: "Audio",
  },
  {
    title: "Fake Telegram Chat",
    description: "Create fake Telegram chat screenshots",
  ...
  },
  {
    ...
    description: "View Excel files",
    icon: <AlignHorizontalDistributeStart className="h-8 w-8 text-primary" />,
  ...
  {
    title: "Text Differencer",
    description: "Highlight differences between two text blocks",
    icon: <AlignVerticalDistributeEnd className="h-8 w-8 text-primary" />,
    href: "/textdeffchecker",
    badge: "Text Diff",
  },
  {
    title: "Secure Notes",
    description: "Write, encrypt, and decrypt notes",
  ...
  {
    title: "Shortcut Keys",
    description: "Git and general shortcut keys",
    icon: <ClipboardList className="h-8 w-8 text-primary" />,
    href: "/shortcut/others",
    badge: "Shortcut",
  },
  {
    title: "Bg Remover",
    description: " Removed Photos Background ",
    icon: <ClipboardList className="h-8 w-8 text-primary" />,
    href: "/bgremover",
    badge: "Bg Remover",
  },
